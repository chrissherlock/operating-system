#!/usr/bin/env python3
# =====================================================================
# fix.py: Embed Butler Lampson image into Module 2 systems aside
# =====================================================================
import os
import subprocess
...
def update_lampson_aside():
    ...
    print(f"--> Successfully embedded Butler Lampson image and attribution into {TARGET_FILE}.")

    try:
        subprocess.run(["git", "add", "fix.py", TARGET_FILE], check=True)
        commit_msg = (
            "Add Butler Lampson image and attribution to systems engineering aside\n\n"
            "Embed images/butler-lampson.jpg into the Butler Lampson research aside in\n"
            "02-hardware-review.html with clean side-by-side flex layout and metadata."
        )
