...
<body>
  ...
  <div class="main-container">
    ...
    <!-- 2. GUIDED WALKTHROUGH WIDGET WITH R-BIT & REGISTER SHIFT VISUALIZATION -->
  ...
  <script>
    /* =========================================================================
       PART 2: WALKTHROUGH LOGIC WITH R-BIT & BIT CELLS
       ========================================================================= */
    let wtStep = 0;
    const wtSteps = [
      {
      ...
      },
      {
        ...
        highlightMsb: true,
        frames: [
          { page: "A", r: 0, reg: 0b11000100, dec: 196 }, // R=1 injected into MSB
          { page: "B", r: 0, reg: 0b00111000, dec: 56 },  // R=0 injected into MSB
          { page: "C", r: 0, reg: 0b01000000, dec: 64 },  // R=0 injected into MSB
          { page: "D", r: 0, reg: 0b10011001, dec: 153 }  // R=1 injected into MSB
        ]
      },
      {
    ...
    /* =========================================================================
       PART 3: INTERACTIVE SANDBOX LOGIC WITH R-BIT & BIT CELLS
       ========================================================================= */
    let agingFrames = [
    ...
    function triggerClockTick() {
      ...
      agingFrames.forEach(f => {
        f.reg = (f.reg >>> 1) | (f.r << 7);
        f.r = 0; // Reset hardware R-bit after injection
      });
