...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .tour-diagram-node { transition: all 0.3s ease; }
    .tour-diagram-box { fill: #ffffff; stroke: #0284c7; stroke-width: 1.5px; rx: 6px; }
  </style>
</head>
<body>
  <div class="nav-back">
  ...
  <div class="main-container">
    ...
    <div class="card tour-panel" id="tourCard">
      ...
      <div style="background: #ffffff; border: 1px solid #7dd3fc; border-radius: 6px; padding: 16px; display: flex; flex-direction: column; align-items: center; gap: 10px; margin-top: 10px;">
        <span style="font-family: var(--font-mono); font-size: 0.78rem; font-weight: 700; color: #0284c7; text-transform: uppercase;" id="tourDiagramCaption">Figure: File Descriptor Table → Open File Table → Buffer Cache Pipeline</span>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 680 140" width="100%" height="100%" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
          <!-- Node: User Process -->
          <g id="tour-d-0" class="tour-diagram-node">
            <rect x="20" y="30" width="120" height="70" class="tour-diagram-box"/>
            <text x="80" y="60" font-size="11" font-weight="700" fill="#0369a1" text-anchor="middle">User Process</text>
            <text x="80" y="78" font-size="9" fill="#475569" text-anchor="middle">fd = 3</text>
          </g>

          <path d="M 140 65 L 190 65" stroke="#0284c7" stroke-width="2" marker-end="url(#tourarrow)"/>

          <!-- Node: Open File Table -->
          <g id="tour-d-1" class="tour-diagram-node">
            <rect x="190" y="30" width="140" height="70" class="tour-diagram-box"/>
            <text x="260" y="55" font-size="11" font-weight="700" fill="#0369a1" text-anchor="middle">Open File Table</text>
            <text x="260" y="72" font-size="9" fill="#475569" text-anchor="middle">Offset: <tspan id="tour-svg-offset" font-weight="700" fill="#0284c7">0B</tspan></text>
            <text x="260" y="86" font-size="9" fill="#475569" text-anchor="middle">Flags: O_RDONLY</text>
          </g>

          <path d="M 330 65 L 380 65" stroke="#0284c7" stroke-width="2" marker-end="url(#tourarrow)"/>

          <!-- Node: Buffer Cache -->
          <g id="tour-d-2" class="tour-diagram-node">
            <rect x="380" y="30" width="130" height="70" class="tour-diagram-box"/>
            <text x="445" y="55" font-size="11" font-weight="700" fill="#0369a1" text-anchor="middle">Buffer Cache</text>
            <text x="445" y="72" font-size="9" fill="#475569" text-anchor="middle">Block #104</text>
            <text x="445" y="86" font-size="9" fill="#059669" font-weight="700" text-anchor="middle" id="tour-svg-cache">RAM Resident</text>
          </g>

          <path d="M 510 65 L 560 65" stroke="#0284c7" stroke-width="2" marker-end="url(#tourarrow)"/>

          <!-- Node: Storage Media -->
          <g id="tour-d-3" class="tour-diagram-node">
            <rect x="560" y="30" width="100" height="70" class="tour-diagram-box"/>
            <text x="610" y="60" font-size="11" font-weight="700" fill="#0369a1" text-anchor="middle">Storage Media</text>
            <text x="610" y="78" font-size="9" fill="#475569" text-anchor="middle">Disks / SSDs</text>
          </g>

          <defs>
            <marker id="tourarrow" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
...
<span class="c-type">int</span> <span class="c-fn">main</span>(<span class="c-type">int</span> argc, <span class="c-type">char</span> *argv[]) {
  ...
  <script>
    const tourStages = [
      {
        ...
        svgOffset: "0B",
        svgCache: "RAM Resident",
        caption: "Figure: File Descriptor Table → Open File Table → Buffer Cache Pipeline"
      },
      {
        ...
        svgOffset: "4096B",
        svgCache: "Cache Hit (RAM)",
        caption: "Figure: read() Data Transfer from Buffer Cache into User Space"
      },
      {
        ...
        svgOffset: "1024B",
        svgCache: "Zero Disk I/O",
        caption: "Figure: lseek() Logical Offset Pointer Repositioning in Open File Table"
      },
      {
        ...
        svgOffset: "Cleared",
        svgCache: "Flushed & Synced",
        caption: "Figure: close() Cache Flush and Descriptor Deallocation"
      }
    ];
    ...
    function updateTourDisplay() {
      ...
      document.getElementById("tour-svg-offset").textContent = stage.svgOffset;
      document.getElementById("tour-svg-cache").textContent = stage.svgCache;
...
COMMIT_MSG = """Add interactive telemetry diagram to file descriptor tour in module 01

Update week10-file-management/01-files-abstraction.html to include an
interactive SVG diagram within the guided tour widget, illustrating buffer
cache data transfers and open file table offset progression."""
...
def execute_pipeline():
    ...
    print(f"Wrote module file with tour diagram to {target_file}")

    run_git_spec = ["git", "add", target_file]
    run_git_step(run_git_spec, "Staging tour diagram update 01-files-abstraction.html")
    run_git_step(["git", "commit", "-a", "-m", COMMIT_MSG], "Committing changes")
    run_git_step(["git", "push", "origin", "main"], "Pushing main to origin")
    print("--> Tour Diagram Module 01 created, committed, and pushed successfully!")
