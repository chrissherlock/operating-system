  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .theme-modern .screen-grid {
      ...
      width: 100%;
      max-width: 1000px;
      height: 140px; /* Reduced height for 20 rows */
    }
    .theme-modern .c-cell {
      aspect-ratio: 1 / 1;
      border-radius: 1px;
    ...
    .theme-olddos .screen-grid {
      ...
      width: 100%;
      max-width: 950px;
      height: 130px; /* Perfectly scaled 20-row height */
    }
    .theme-olddos .c-cell {
      aspect-ratio: 1 / 1.4;
      border-radius: 0;
...
COMMIT_MSG = """Reduce matrix rows to 20 for single-screen 800x600 fit

Update week10-file-management/03-filesystem-implementation.html to reduce
the grid row count from 30 to 20 (1,000 total blocks), ensuring the entire
defrag program boundary fits easily within 600px vertical height."""
...
def deploy_module():
    ...
    run_git_step(["git", "add", target_file], "Staging 20-row fit update")
    run_git_step(["git", "commit", "-a", "-m", COMMIT_MSG], "Committing changes")
    run_git_step(["git", "push", "origin", "main"], "Pushing main to origin")
    print("--> 20-row strict screen fit successfully deployed!")
