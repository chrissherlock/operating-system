...
COMMIT_MSG = """Add active button state highlighting to sticky action control bar

Update week10-file-management/01-files-abstraction.html to visually highlight
the currently active system call button in the sticky control bar when clicked."""
...
def execute_pipeline():
    ...
    print(f"Wrote module file with button highlighting to {target_file}")

    run_git_step(["git", "add", target_file], "Staging button highlight update 01-files-abstraction.html")
    run_git_step(["git", "commit", "-a", "-m", COMMIT_MSG], "Committing changes")
    run_git_step(["git", "push", "origin", "main"], "Pushing main to origin")
    print("--> Button Highlight Module 01 created, committed, and pushed successfully!")
