#!/usr/bin/env python3
# =====================================================================
# fix.py: Deeply expand Section 3 in 02-process-lifecycle.html
# =====================================================================
import os
import subprocess
...
def apply_section_three_expansion():
    ...
    try:
        ...
        commit_msg = (
            ...
            "Enrich Section 3 with runtime cleanup cascades, CPU exception vectors,\n"
            "POSIX signal delivery barriers, and a termination comparison matrix."
        )
