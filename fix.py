#!/usr/bin/env python3
# =====================================================================
# fix.py: Add virtual address definition to hardware terminology glossary
# =====================================================================
import os
import subprocess
...
def add_virtual_address_definition():
    ...
    # Old glossary card HTML block without Virtual Address definition card
    ...
    # Updated glossary card HTML including Virtual Address definition
    ...
    if old_glossary in content:
        ...
        print("--> Added Virtual Address definition to the hardware glossary card.")
    else:
    ...
    try:
        ...
        commit_msg = (
            "Add virtual address definition to translation simulator key definitions glossary\n\n"
            "Define 'Virtual Address' in the hardware terminology card within\n"
            "02-hardware-review.html to explain CPU-generated addresses before translation."
        )
        subprocess.run(["git", "commit", "-m", commit_msg], check=True)
        subprocess.run(["git", "push", "origin", "main"], check=True)
        print("--> Git sync completed successfully for Virtual Address addition!")
    except Exception as e:
        print(f"Git execution note: {e}")

if __name__ == "__main__":
    add_virtual_address_definition()
