    ...
    <div class="card tour-panel" id="tourCard">
      ...
      <div class="telemetry-grid">
        ...
        <div class="telemetry-box">
          ...
          <span class="telemetry-value" id="tel-oft">Not Allocated</span>
        </div>
        <div class="telemetry-box">
          <span class="telemetry-label">In-Memory I-Node</span>
          <span class="telemetry-value" id="tel-inode">Inactive</span>
        </div>
      </div>
...
COMMIT_MSG = """Enhance file descriptor tutorial with interactive state inspector

Update week10-file-management/01-files-abstraction.html to overhaul the
file descriptor lifecycle tour into an engaging, state-inspecting guided
walkthrough with real-time kernel telemetry readouts."""
...
def execute_pipeline():
    ...
    print(f"Wrote module file with engaging tour to {target_file}")

    run_git_step(["git", "add", target_file], "Staging engaging tour update 01-files-abstraction.html")
    run_git_step(["git", "commit", "-a", "-m", COMMIT_MSG], "Committing changes")
    run_git_step(["git", "push", "origin", "main"], "Pushing main to origin")
    print("--> Engaging Tour Module 01 created, committed, and pushed successfully!")
