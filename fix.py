#!/usr/bin/env python3
# =====================================================================
# update_tanenbaum_portrait.py: Add Tanenbaum portrait to Chapter 1 aside
# =====================================================================
import os
import subprocess
import sys

WIKI_ASIDE_TANENBAUM = r"""
        <!-- WIKIPEDIA ASIDE BOX WITH TANENBAUM PORTRAIT -->
          ...
          <div style="display: flex; gap: 16px; align-items: flex-start; margin-bottom: 12px;">
            <div style="display: flex; flex-direction: column; align-items: center; gap: 4px; flex-shrink: 0;">
              <div style="width: 120px; height: 150px; background: #e2e8f0; border-radius: 4px; overflow: hidden; border: 1px solid #bae6fd;">
                <img src="../images/tanenbaum.jpeg" alt="Andrew S. Tanenbaum Portrait" style="width: 100%; height: 100%; object-fit: cover;">
              </div>
...
def update_tanenbaum_aside():
    ...
    if os.path.exists(portal_path):
        ...
        if target in content:
            content = content.replace(target, WIKI_ASIDE_TANENBAUM + "\n\n    " + target, 1)
    ...
    try:
        ...
        commit_msg = (
            "Add Andrew S. Tanenbaum portrait and photo credit to Chapter 1 research aside\n\n"
            "Update week01-operating-system-concepts/index.html to include images/tanenbaum.jpeg\n"
            "portrait and photographer attribution within the operating system foundations aside box."
        )
        subprocess.run(["git", "commit", "-m", commit_msg], check=True)
        subprocess.run(["git", "push", "origin", "main"], check=True)
    except Exception:
        pass
    print("--> Andrew S. Tanenbaum portrait successfully deployed to Week 1 portal index aside!")

if __name__ == "__main__":
    update_tanenbaum_aside()
