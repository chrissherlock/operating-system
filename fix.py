...
def execute_deployment():
    ...
    print(f"--> Updating Inode Map & log tail content in {html_file}...")
    ...
    commit_msg = (
        "Deepen Imap and sequential log tail explanation with upgraded diagram\n\n"
        "Update week10-file-management/03-filesystem-implementation.html to "
        "comprehensively explain the Inode Map (Imap) indirection mechanism, "
        "define the sequential log tail write frontier, and integrate an enhanced "
