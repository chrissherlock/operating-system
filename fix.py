...
<body>
  ...
  <div class="main-container">
    ...
    <!-- Section 3: Interactive Kernel Table Inspector Sandbox -->
    <div class="card kernel-sandbox">
      <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px;">
        <div style="font-weight: 700; font-size: 1.1rem; color: #f8fafc;">3. Interactive Kernel Table Inspector Sandbox</div>
