...
<body>
      ...
      <div class="split-grid">
        ...
        <div>
          ...
          <table class="table-spec" style="margin-top:6px;">
            <thead>
              <tr><th>Frame</th><th>Page</th><th>R</th><th>8-Bit Register (Binary Cells)</th><th>Decimal</th></tr>
            </thead>
  ...
  <script>
    /* =========================================================================
       PART 2: WALKTHROUGH LOGIC WITH VISUAL BIT CELLS
       ========================================================================= */
    let wtStep = 0;
    const wtSteps = [
      {
      ...
      },
      {
        ...
        text: "When a clock tick occurs, each 8-bit register shifts right by 1 ($\gg 1$), and the current hardware $R$ bit is injected into Bit 7 (MSB, highlighted in green).",
        highlightMsb: true,
        frames: [
      ...
      },
      {
        ...
        text: "When a page fault occurs, the kernel evaluates unsigned decimal values: Page B (56), Page C (64), Page D (153), Page A (196).",
        frames: [
          { page: "A", r: 1, reg: 0b11000100, dec: 196 },
    ...
    /* =========================================================================
       PART 3: INTERACTIVE SANDBOX LOGIC WITH BIT CELLS
       ========================================================================= */
    let agingFrames = [
...
def main():
    ...
    print(f"Successfully generated {target_file} with clear individual bit-cells and MSB highlighting.")
